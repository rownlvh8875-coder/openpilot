...
후속 작업에서 새 upstream의 선택 반영·제외 방침을 검토했습니다. 아래 초기 보류 기록 이후의 처리 내역은 [선택 통합 검토](UPSTREAM_DISPOSITION_20260908.md)에 있으며, 실제 현재 호환성은 해당 disposition과 최신 source-compatibility 실행 결과로 확인합니다.
